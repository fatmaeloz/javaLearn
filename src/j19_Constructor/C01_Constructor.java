...
// fields-> obj variable => obj değerlerin aldıgı alan özellikler
    String str;//class levelda obj variable
    String selam="herkese selamlar bolca offerlar";//
    C01_Constructor obj1=new C01_Constructor();//class levelde
    C01_HelloWorld obj99=new C01_HelloWorld();
/*
