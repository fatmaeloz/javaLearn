...
public class C05_Arac {
    ...
    public C05_Arac() {
        System.out.println("p siz const run oldu");
    }

    public C05_Arac(String model) {//1 p li const.
        this("Hacı Murat",123);//full p li cons call edildi
    ...
    */
        this.model = model;
        System.out.println("1 p'li const run oldu");

    }

    public C05_Arac(String model, int maxHiz) {//full p li const
        this();//p siz const call edildi->const call mutlaka body nin ilk satırında olmalı yoksa CTE
        this.model = model;
        this.maxHiz = maxHiz;
    }
