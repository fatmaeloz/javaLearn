...
public class C01_Iterators {
    public static void main(String[] args) {
        ...
        System.out.println("L1 listin ilk hali : " + l1);//[Sema, Semra, Dogukan, Ahmet, Halit, Tuba, Seher]

        System.out.println("*** Task 01 ***");
        //Task01-> l1 elemanlarını for loop ile print eden code create ediniz.
        for (int i = 0; i < l1.size(); i++) {
            System.out.print(l1.get(i) + " ");//Sema Semra Dogukan Ahmet Halit Tuba Seher
        }
        System.out.println();
 ...
 */
        ...
        System.out.println("l1 iterator remove sonrasi : " + l1);//[]
        ...
        System.out.println("ListIterator oncesi l2 : " + l2);//[javaCAN, javvaNUR, javaNAZZZ, javaSU, javaHAN, javaZADE, javaTAR, javaLAZIM]
