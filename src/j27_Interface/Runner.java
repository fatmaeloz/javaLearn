...
public class Runner {
    public static void main(String[] args) {
        ...
        DışDonanım.anten();//static concrete meth interfaceName ile call edildi->Cekemeyen anten taksin
        System.out.println("DisDonanim.RENK = " + DışDonanım.RENK);//Kirmizi
        System.out.println("IcDonanim.RENK = " + İçDonanım.RENK);//Yavru agzi
        System.out.println("Lastik.RENK = " + Lastik.RENK);//Cingene pembasi
        System.out.println("IcDonanim.KUMAS = " + İçDonanım.KUMAS);//Kadife
        System.out.println("IcDonanim.MUSIC = " + İçDonanım.MUSIC);//Selvi boylum
    }
}
