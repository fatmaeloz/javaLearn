...
/*  Eğer String null (0) değilse ve String uzunluğu 14 ise ve String "i love java" yı kapsıyorsa
        ...
        if ((str!=null) && (str.length()==14) && (str.contains("i love java"))) System.out.println("String is I love java");
        else if ((str!=null) && str.equalsIgnoreCase("i love java")) System.out.println("String is I love java");
